        ...
        while(!al_is_event_queue_empty(eventsQueue)){
            ...
            switch(option){
                case 0:
                    ...
                    break;
                case 1:
                    al_draw_bitmap(seta, LARGURA/2 - 250, ALTURA/2, -30);
                    break;
                case 2:
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------  
    ...
    while(help)
    {
       ...
       al_draw_text(font_1, al_map_rgb(255,255,255), 100, 420, ALLEGRO_ALIGN_LEFT, "02. GOAL");
...
//-------------------------------------------------------------------------------------------------------------------------------------
        while(menuConnection)
        {
            ...
            while(!al_is_event_queue_empty(eventsQueue)){
                ...
                al_draw_text(font_1, al_map_rgb(255,0,0), LARGURA/2-10, ALTURA/2 - 50, ALLEGRO_ALIGN_CENTRE, "ENTER THE SERVER'S IP:");
                al_draw_rectangle(LARGURA/2 - 320, ALTURA/2, LARGURA/2 + 320, ALTURA/2 + 50, al_map_rgb(255,0,0), 2);
                al_draw_text(font_1, al_map_rgb(255,255,255), LARGURA/2, ALTURA/2+6, ALLEGRO_ALIGN_CENTRE, ipOficial);
                al_draw_text(font_1, al_map_rgb(255, 0, 0), LARGURA/2-10, ALTURA/2 + 70, ALLEGRO_ALIGN_CENTRE, "ENTER YOUR NICKNAME:");
                al_draw_text(font_1, al_map_rgb(255,255,255), LARGURA/2, ALTURA/2 + 126, ALLEGRO_ALIGN_CENTRE, nickname);
                al_draw_rectangle(LARGURA/2 - 320, ALTURA/2 + 120, LARGURA/2 + 320, ALTURA/2 + 170, al_map_rgb(255, 0, 0), 2);
